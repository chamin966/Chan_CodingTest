...
2. 점화식 찾아내기 → 일반적으로 가장 핵심적인 부분이다.
  ...
  1. 각 단계별로 가능한 합산과 같은 결과값을 수열이나 2차원 배열로 구해본다. 
  2. 수열이나 배열 자체에서 규칙을 발견하거나,
...
*****
이때, 가장 중요한 것은 점화식을 활용하여 DP 테이블을 만드는 것이다.
dp 테이블을 N번째가 정답일수도 있지만,
dp 테이블에 담긴 결과값들 중에 정답이 있다는 것에 주의해야 한다.
*****
